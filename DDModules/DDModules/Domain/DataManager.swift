...
public class DataManager : ObservableObject{
    ...
    public init(remoteWeatherRepo: RemoteWeatherRepo, locationManager: LocationManager, localRepository : LocalRepository){
    ...
    public func getLocalData(q: String, days:Int, sendDataToView: @escaping (WeatherRealm?) -> Void){
    ...
    public func getDefaultLocation(onCompletion: @escaping (String) -> Void){
